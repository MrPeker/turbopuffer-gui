...
### Security
- API keys encrypted using OS-native secure storage (Keychain, DPAPI, Secret Service)
- Context isolation and sandbox enabled
- Security fuses enabled for packaged application

[Unreleased]: https://github.com/MrPeker/turbopuffer-gui/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/MrPeker/turbopuffer-gui/releases/tag/v1.0.0
