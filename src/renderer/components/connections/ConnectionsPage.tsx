...
import { RefreshCw, Plus, Database, Search, AlertTriangle } from 'lucide-react';
  ...
  if (connections.length === 0 && !searchTerm) {
    return (
      <div className="flex flex-col h-full bg-tp-bg">
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-amber-500/10 border-b border-amber-500/30 text-xs">
          <AlertTriangle className="h-3 w-3 text-amber-500 flex-shrink-0" />
          <span className="text-amber-700 dark:text-amber-400">
            <strong>Beta:</strong> For testing and development only. Do not use with production data.
          </span>
        </div>
